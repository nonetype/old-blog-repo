...
## Today
### What I Did
- Home network connected! Yeaaaaah!
  - Re-setting server network env
- Developing Triage
  - Crash parsing, run Qemu
- Blog cleaning
  - Remove unused features
    - Google Analytics(why is it here? I didn't apply!)
    - Disqus(I forgot removing this)
  - changed post informs
    - before: '18 Feb 2020 in TIL on 2020'
    - after: 'Posted by nonetype on Feb 18, 2020. 1 min to read'
      - applied Time-to-read!
